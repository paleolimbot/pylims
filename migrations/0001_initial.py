# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-08-04 17:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mapping', pylims.models.TagsField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('sample_id', models.CharField(blank=True, max_length=55, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True)),
                ('tags', pylims.models.TagsField()),
                ('param', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='pylims.Parameter')),
