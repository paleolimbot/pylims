# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-11-23 15:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.CharField(default='csv_import', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pylims.DataImport')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
            fields=[
                ...
                ('data_import', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pylims.DataImport')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.TextField()),
                ('data_import', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pylims.DataImport')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pylims.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Measurement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.TextField()),
                ('data_import', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pylims.DataImport')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pylims.Parameter')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.TextField()),
                ('data_import', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pylims.DataImport')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pylims.Project')),
            ],
        ),
        migrations.CreateModel(
            name='Sample',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.TextField()),
                ('data_import', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pylims.DataImport')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pylims.Sample')),
            ],
        ),
        migrations.AddField(
