...
urlpatterns = [
    ...
    url(r'^parameter/$', views.ParameterListView.as_view(), name="samplemetakey_list"),
    url(r'^parameter/(?P<pk>[0-9]+)$', views.ParameterDetailView.as_view(), name="samplemetakey_detail"),
